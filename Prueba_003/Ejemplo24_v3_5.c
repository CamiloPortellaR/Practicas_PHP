...
int32 f_PICtoIEEE(float f)
{
 ...
 void enviar_data_to_SP(int32 fx,int16 address_SitePlayer){
     ...
     // el envio de la trama.
        //disable_interrupts(INT_EXT);//* ESTO YA NO ES NECESARIO YA QUE LA 
     //                                   DESHABILITACION LO HE REALIZADO EN 
     //                                   "transaccion_read_MB_and_write_SP" EL
     //                                   CUAL CONTIENE A "enviar_data_to_SP".
